...
guardar dentro de um vetor esses valores. Posteriormente precisamos
verificar os valores armazenados para retornar para o usuário se a mesa
precisa pagar ou não algum valor. Caso nenhum valor precise ser pago deve
ser retornada a mensagem "Nada a pagar!". Caso a mesa precise pagar
algum valor deve ser retornado "A mesa x precisa pagar: " e logo em seguida
ser retornado quanto a mesa deve. Lembrando que precisamos fazer isso
para todas as mesas. */
/* $$$ Portugol Studio $$$ 
 * 
